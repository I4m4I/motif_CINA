...
def main() -> None:
    ...
    parser.add_argument("--cdf-data", type=Path, default=repo_root() / "data" / "topology" / "fig6f" / "cumulative_distribution_curves_fig6f.npz")
    parser.add_argument("--ks-values", type=Path, default=repo_root() / "data" / "topology" / "fig6f" / "KS_test_values_for_fig6f_annotation.csv")
    parser.add_argument("--output-dir", type=Path, default=repo_root() / "figures" / "topology" / "fig6f")
