...
def main() -> None:
    ...
    parser.add_argument("--values", type=Path, default=repo_root() / "data" / "topology" / "KS_test_heatmap_fig6g.csv")
    parser.add_argument("--output", type=Path, default=repo_root() / "figures" / "topology" / "KS_test_heatmap_fig6g.png")
