...
def main() -> None:
    ...
    parser.add_argument("--weight-data", type=Path, default=repo_root() / "data" / "topology" / "figS10" / "weight_matrices_figS10.npz")
    parser.add_argument("--output-dir", type=Path, default=repo_root() / "figures" / "topology" / "figS10")
