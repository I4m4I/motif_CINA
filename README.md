...
| **Fig. 6 / S10** (graph topology) | `*/topology/` | `modularity`, `smallworld`, `network_*` (community panels), `cumulative_distribution_curves_fig6f`, `KS_test_heatmap_fig6g`, `weight_matrices_figS10` |
